package com.luv2code.task2.controller;

import com.luv2code.task2.FileManager;
import com.luv2code.task2.model.Circle;
import com.luv2code.task2.model.Rectangle;
import com.luv2code.task2.model.Shape;
import com.luv2code.task2.model.Triangle;
...
public class ShapeController {
    ...
    public void saveShapes(String filename) {
        FileManager.saveShapesToFile(filename, shapes);
    }

    public void loadShapes(String filename) {
        Shape[] loaded = FileManager.loadShapesFromFile(filename);
        if (loaded != null) {
            shapes = loaded;
            view.displayMessage("Shapes loaded from file.");
        } else {
            view.displayMessage("Loading shapes failed.");
        }
    }
}
